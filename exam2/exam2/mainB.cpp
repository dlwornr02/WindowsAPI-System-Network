...
//	WndClass.lpszClassName = "BB";	
//	RegisterClass(&WndClass);	
//	hwnd = CreateWindow("BB",
//		"BB",
//		WS_OVERLAPPEDWINDOW,
//		CW_USEDEFAULT,	
//		CW_USEDEFAULT,	
...
//		CloseHandle(CreateThread(NULL,0,TFcount,(LPVOID)ptp,0,&id));
//		CloseHandle(CreateThread(NULL,0,TFLine,(LPVOID)ptp,0,&id));
//		Sleep(10);
//		CloseHandle(CreateThread(NULL,0,TFText,(LPVOID)ptp,0,&id));
//		break; 
//	case WM_SIZE:
//		GetClientRect(hwnd,&clientrt);
//		break;
...
{
	HWND hWndA = FindWindow(NULL, TEXT("AA"));
	if( hWndA )
				   ...
				   LPSTR lpszCmdLine, int nCmdShow)
{
	...
	WndClass.hbrBackground = (HBRUSH)GetStockObject(WHITE_BRUSH);	
	WndClass.lpszMenuName = NULL;		
	WndClass.lpszClassName = TEXT("BB");	
	RegisterClass(&WndClass);	
	hwnd = CreateWindow("bb",
		TEXT("BB"),
		WS_OVERLAPPEDWINDOW,
